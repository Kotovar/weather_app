...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ../../../../img/loupe.svg */ "./img/loupe.svg"), __webpack_require__.b);
...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA,oBAAoB;AACpB;EACE,SAAS;EACT,UAAU;EACV,aAAa;EACb,sBAAsB;AACxB;;AAEA;EACE,wCAAwC;EACxC,4BAA4B;AAC9B;;AAEA;EACE,QAAQ;AACV;;AAEA;EACE,sBAAsB;EACtB,wBAAwB;EACxB,iCAAiC;EACjC,qCAAqC;EACrC,mCAAmC;EACnC,mCAAmC;AACrC;;AAEA,iCAAiC;AACjC;EACE,kEAAkE;AACpE;;AAEA,wBAAwB;AACxB;EACE,wCAAwC;EACxC,YAAY;EACZ,WAAW;EACX,eAAe;EACf,aAAa;EACb,mBAAmB;EACnB,uBAAuB;AACzB;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,yCAAyC;EACzC,WAAW;EACX,WAAW;EACX,eAAe;EACf,YAAY;EACZ,4BAA4B;EAC5B,6BAA6B;EAC7B,0CAA0C;AAC5C;;AAEA;EACE,yCAAyC;EACzC,yDAAqC;EACrC,4BAA4B;EAC5B,oBAAoB;EACpB,2BAA2B;EAC3B,WAAW;EACX,UAAU;EACV,YAAY;EACZ,4BAA4B;AAC9B;;AAEA,yBAAyB;AACzB;EACE,iBAAiB;EACjB,6BAA6B;AAC/B;;AAEA;EACE,kBAAkB;EAClB,0CAA0C;AAC5C;;AAEA;EACE,kBAAkB;EAClB,6BAA6B;EAC7B,0CAA0C;AAC5C;;AAEA,8BAA8B;AAC9B;EACE,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;EACnB,0CAA0C;EAC1C,wBAAwB;AAC1B;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,SAAS;AACX;;AAEA;EACE,aAAa;EACb,YAAY;AACd;;AAEA,oCAAoC;AACpC;EACE,aAAa;EACb,8CAA8C;EAC9C,qBAAqB;EACrB,cAAc;AAChB;;AAEA;EACE,sBAAsB;EACtB,mBAAmB;AACrB;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,WAAW;EACX,aAAa;EACb,sBAAsB;EACtB,kBAAkB;AACpB;;AAEA,qBAAqB;AACrB;EACE,kBAAkB;EAClB,cAAc;EACd,0CAA0C;AAC5C;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,SAAS;EACT,mBAAmB;AACrB;;AAEA;EACE,0CAA0C;EAC1C,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,SAAS;AACX;;AAEA,mCAAmC;AACnC;EACE;IACE,WAAW;IACX,WAAW;EACb;;EAEA;IACE,0BAA0B;IAC1B,iCAAiC;EACnC;EACA;IACE,SAAS;IACT,gBAAgB;EAClB;AACF;;AAEA;EACE;IACE,wBAAwB;EAC1B;;EAEA;IACE,0BAA0B;IAC1B,qBAAqB;IACrB,cAAc;EAChB;EACA;IACE,mBAAmB;EACrB;EACA;IACE,WAAW;IACX,uBAAuB;EACzB;;EAEA;IACE,uBAAuB;IACvB,mBAAmB;EACrB;AACF","sourcesContent":["/* Общие настройки */\n* {\n  margin: 0;\n  padding: 0;\n  outline: none;\n  box-sizing: border-box;\n}\n\nbody {\n  background-color: var(--main-bkgd-color);\n  font-family: \"Cinzel\", serif;\n}\n\nbody::-webkit-scrollbar {\n  width: 0;\n}\n\n:root {\n  --main-font-size: 1rem;\n  --main-font-color: white;\n  --title_color: rgb(163, 163, 231);\n  --date-font-color: rgb(168, 160, 160);\n  --main-bkgd-color: rgb(70, 65, 113);\n  --input-bkgd-color: rgb(39, 37, 63);\n}\n\n/* иконки для направления ветра */\n.material-symbols-outlined {\n  font-variation-settings: \"FILL\" 0, \"wght\" 400, \"GRAD\" 0, \"opsz\" 24;\n}\n\n/* Верхняя часть сайта */\nheader {\n  background-color: var(--main-bkgd-color);\n  height: 10vh;\n  width: 100%;\n  position: fixed;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\nheader form {\n  display: flex;\n}\n\n#cityInput {\n  background-color: var(--input-bkgd-color);\n  height: 5vh;\n  width: 30vw;\n  padding: 0 1rem;\n  border: none;\n  border-radius: 15px 0 0 15px;\n  color: var(--main-font-color);\n  font-size: calc(var(--main-font-size) * 2);\n}\n\n#pushSearchButton {\n  background-color: var(--input-bkgd-color);\n  background-image: url(/img/loupe.svg);\n  background-repeat: no-repeat;\n  background-size: 70%;\n  background-position: center;\n  height: 5vh;\n  width: 3vw;\n  border: none;\n  border-radius: 0 15px 15px 0;\n}\n\n/* Основная часть сайта */\nmain {\n  padding-top: 10vh;\n  color: var(--main-font-color);\n}\n\n#cityName {\n  text-align: center;\n  font-size: calc(var(--main-font-size) * 4);\n}\n\n#currentDate {\n  text-align: center;\n  color: var(--date-font-color);\n  font-size: calc(var(--main-font-size) * 3);\n}\n\n/* карточки погоды - основная*/\n#currentWeatherMainForm {\n  display: grid;\n  grid-template-columns: 1fr 4fr;\n  align-items: center;\n  font-size: calc(var(--main-font-size) * 2);\n  margin: 2rem 1rem 0 1rem;\n}\n\n#currentTemperature {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 1rem;\n}\n\n#currentTemperature img {\n  height: 10rem;\n  width: 10rem;\n}\n\n/* карточки погоды - дополнительные*/\n#currentWeatherCards {\n  display: grid;\n  grid-template: repeat(3, 1fr) / repeat(3, 1fr);\n  justify-items: center;\n  grid-gap: 1rem;\n}\n\n#currentWind {\n  flex-direction: column;\n  align-items: center;\n}\n\n.title {\n  color: var(--title_color);\n}\n\n.cards {\n  gap: 0.5rem;\n  display: flex;\n  flex-direction: column;\n  text-align: center;\n}\n\n/* погода - прогноз */\n#titleForecast {\n  text-align: center;\n  margin: 3rem 0;\n  font-size: calc(var(--main-font-size) * 3);\n}\n\n#forecastWeather {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  gap: 5rem;\n  margin-bottom: 3rem;\n}\n\n.forecastCard {\n  font-size: calc(var(--main-font-size) * 2);\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 1rem;\n}\n\n/* настройки для мобильной версии */\n@media (max-width: 768px) {\n  #cityInput {\n    height: 5vh;\n    width: 90vw;\n  }\n\n  #currentWeatherMainForm {\n    grid-template-columns: 1fr;\n    /* grid-template-rows: 1fr 1fr; */\n  }\n  #forecastWeather {\n    gap: 1rem;\n    margin-bottom: 0;\n  }\n}\n\n@media (max-width: 576px) {\n  :root {\n    --main-font-size: 0.8rem;\n  }\n\n  #currentWeatherCards {\n    grid-template-columns: 1fr;\n    justify-items: center;\n    grid-gap: 1rem;\n  }\n  #currentTemperature {\n    margin-bottom: 1rem;\n  }\n  .cards {\n    gap: 0.5rem;\n    justify-content: center;\n  }\n\n  .title {\n    border: 2px solid black;\n    border-radius: 10px;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
...
function setDate() {
  const date = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), "EEEE, dd MMMM yyyy, H.mm");
...
module.exports = __webpack_require__.p + "ca17fcad9096dbecc5f7.svg";
...
/* harmony import */ var _setWeather__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./setWeather */ "./src/setWeather.js");
...
(0,_date__WEBPACK_IMPORTED_MODULE_1__["default"])();
(0,_setWeather__WEBPACK_IMPORTED_MODULE_2__["default"])("Krasnoyarsk");

function changeCity() {
  pushSearchButton.addEventListener("click", () => {
    if (cityInput.value) {
      (0,_setWeather__WEBPACK_IMPORTED_MODULE_2__["default"])(cityInput.value);
      cityInput.value = "";
    }
  });
